...
import {
    SchoolP, SchoolD, TeamsContainer, TeamsHeder, TeamsText, TeamsSochmed, SchoolBeck, SchoolBeck1, SchoolBeck2, SchoolBeck3,
    TeamsItem, TeamsLinks, TeamsSvg, TeamsDIrems, SchoolTeams, SchoolLegend, TeamsDLegend, SchoolImg, ScoolContImg, ContImg, SchoolPBolt
} from './School.styled';
...
import Back1 from "../../images/Vector1.png";
import Back2 from "../../images/Vector2.png";
import Back3 from "../../images/Vector7.png";
import Back4 from "../../images/image26.png";

export const School = () => {
    return (
        <SchoolD>
            <div> <SchoolBeck src={Back1} alt="Head img"></SchoolBeck>
            <SchoolBeck1 src={Back2} alt="Head img"></SchoolBeck1>
            
            </div>
            
            <SchoolP><SchoolPBolt>ФК “Оболонь”</SchoolPBolt> пишається своєю довгою історією виховання юнаків для першої команди клубу, професійного футболу загалом і багатьох інших сфер спорту та життя.
            ...
            <div> <SchoolBeck2 src={Back3} alt="Head img"></SchoolBeck2>
            <SchoolBeck3 src={Back4} alt="Head img"></SchoolBeck3>
